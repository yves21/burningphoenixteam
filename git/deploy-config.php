 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'a4NA38a6V2ruSFz');
/**
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'git@github.com:yves21/burningphoenixteam.git');
/**
 ...
 */
define('TARGET_DIR', '/opt/lampp/htdocs/burningphoenixteam');
/**
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/opt/lampp/temp/spgd-'.md5(REMOTE_REPOSITORY).'/');
/**
