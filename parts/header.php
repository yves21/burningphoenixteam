...
<nav>
    <ul class="nav nav-pills">
        ...
        <li <?php if ($pagename=='presentation.php') { echo "class=\"active\""; } ?>><a href="#">Présentation de la team</a></li>
        <li <?php if ($pagename=='historique.php') { echo "class=\"active\""; } ?>><a href="#">Historique des BPT</a></li>
        <li <?php if ($pagename=='recrut.php') { echo "class=\"active\""; } ?>><a href="#">Page contact recrutement</a></li>
        <li class="dropdown">
