...
$lang['email_activation_body'] = 'Bonjour,<br/><br/> Pour pouvoir vous connecter vous devez d\'abord activer votre compte en cliquant sur le lien suivant :<strong><a href="%1$s/%2$s%3$s">%1$s/confirm</a></strong><br/><br/>Pour information, votre cl&eacute; d\'activation est : <strong>%3$s</strong><br/><br/>Si vous ne souhaitez pas vous enregistrer sur %1$s vous pouvez ignorer ce message.';
$lang['email_activation_altbody'] = 'Bonjour,' . "\n\n" . 'Pour pouvoir vous connecter vous devez d\'abord activer votre compte en cliquant sur le lien suivant :' . "\n" . '%1$s/%2$s%3$s' . "\n\n" . 'Pour information, votre cl&eacute; d\'activation est : %3$s' . "\n\n" . 'Si vous ne souhaitez pas vous enregistrer sur %1$s vous pouvez ignorer ce message.';

$lang['email_reset_subject'] = '%s - Reinitialisation du mot de passe';
$lang['email_reset_body'] = 'Bonjour,<br/><br/>Pour r&eacute;initialiser votre mot de passe cliquez sur le lien suivant :<br/><br/><strong><a href="%1$s/%2$s%3$s">%1$s/reset</a></strong><br/><br/>Pour information, votre cl&eacute; de r&eacute;initialisation est : <strong>%3$s</strong><br/><br/>Si vous n\'avez pas demand&eacute; une r&eacute;initialisation du mot de passe, vous pouvez ignorer ce message.';
$lang['email_reset_altbody'] = 'Bonjour,' . "\n\n" . 'Pour r&eacute;initialiser votre mot de passe cliquez sur le lien suivant :' . "\n" . '%1$s/%2$s%3$s' . "\n\n" . 'Pour information votre cl&eacute; de r&eacute;initialisation est :  %3$s' . "\n\n" . 'Si vous n\'avez pas demand&eacute; une r&eacute;initialisation du mot de passe, vous pouvez ignorer ce message.';

$lang['account_deleted'] = "Compte supprim&eacute;.";
